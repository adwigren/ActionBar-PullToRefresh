...
public class PullToRefreshAttacher implements View.OnTouchListener {
    ...
    public final boolean onTouch(View view, MotionEvent event) {
        ...
        case MotionEvent.ACTION_MOVE: {
            ...
            // As there are times when we are not given the ACTION_DOWN, we need
            // to check here
    ...
    public static class DefaultHeaderTransformer extends HeaderTransformer {
        ...
        protected Drawable getActionBarBackground(Context context) {
            ...
            // };
            //
            // // Need to get resource id of style pointed to from
            // actionBarStyle
            ...
            // TypedArray abStyle =
            // context.getTheme().obtainStyledAttributes(outValue.resourceId,
